...
500 because I multiply the number of users by their average friends then divide that by two since making a friendship leaves two users with a friendship.
